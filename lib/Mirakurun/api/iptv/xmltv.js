...
function escapeXMLSpecialChars(str) {
...
const get = async (req, res) => {
    ...
    for (const program of _1.default.program.itemMap.values()) {
        const service = _1.default.service.get(program.networkId, program.serviceId);
        if (service === null) {
            continue;
        }
